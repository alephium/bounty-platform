...
const faqs = [
  {
    ...
    answer: `Any team or project that is building in the Solana ecosystem can sponsor a listing on Alephium. Size of the team or operations don't matter — you can be a tokenised project or a small grantee; as long as you are building on the Solana blockchain, you can add a listing on Earn.`,
  },
  {
  ...
  },
  {
    ...
    answer: `The sponsors are supposed to review, announce, and pay out the winners on Alephium. It's super simple to manage your submissions, all within Earn.`,
  },
  {
  ...
  {
    question: 'What can I use Alephium for?',
    answer: `Alephium is a platform to get work done from crypto-native talent. This can be in the form of boutnies (get the same work done by many people) or hiring freelancers in the form of Project listings.
<br />
...
<br />
<a style="color: blue" href="https://in.contribium/bounty-menu" target="_blank" >Click here</a> to access the Listings Menu, which contains ideas, listing examples, suggested prize ranges, etc.`,
  },
  {
