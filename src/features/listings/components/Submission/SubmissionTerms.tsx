      ...
      <ModalContent overflow="hidden" rounded="lg">
        ...
        >
          <UnorderedList>
            ...
            <ListItem>
              Alephium acts solely as a platform for the Partner to list
              contests, bounties, projects or similar engagements{' '}
              {`("Activities")`} on its platform {`(“ST Earn Platform”)`}.
            </ListItem>
            <ListItem>
              Alephium shall not be liable for any Activities listed by
            ...
            <ListItem>
              ...
              their own risk and discretion. Alephium disclaims all
            ...
            <ListItem>
              ...
              parties involved. Alephium shall not be responsible for
              mediating or resolving such disputes.
            </ListItem>
            <ListItem>
              By using the platform and participating in any Activities, users
              agree to release Alephium from any claims, liabilities, or
              damages arising from their participation in Activities listed by
              Partners.
            </ListItem>
            <ListItem>
              Alephium does not guarantee the accuracy or legality of
            ...
            <ListItem>
              ...
              hold Alephium harmless from any claims, damages, or
