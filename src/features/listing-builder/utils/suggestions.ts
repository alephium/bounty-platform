    ...
    suggestions: [
      {
        ...
        link: 'https://contribium/listings/bounty/write-a-twitter-thread-on-rome-protocol/',
      },
      {
        label: 'History of Bonk [Twitter Thread]',
        link: 'https://contribium/listings/bounty/history-of-bonk-twitter-thread/',
      },
    ],
  },
  {
    ...
    suggestions: [
      {
        ...
        link: 'https://contribium/listings/bounty/deep-dive-on-the-state-of-the-ondc-network/',
      },
      {
        label: 'Deep Dive on Monaco Protocol',
        link: 'https://contribium/listings/bounty/deep-dive-on-monaco-protocol-article/',
      },
    ],
  },
  {
    ...
    suggestions: [
      {
        ...
        link: 'https://contribium/listings/bounty/y00ts-royalty-dashboard-design/',
      },
      {
        label: 'Redesign Symmetry App',
        link: 'https://contribium/listings/bounty/redesign-symmetry-app/',
      },
    ],
  },
];
