        ...
        <form onSubmit={handleSubmit(onSubmit)} style={{ width: '100%' }}>
          ...
          <FormControl w="full" mb={5} isInvalid={!!errors.referredBy}>
            <Flex>
              ...
              <ListingTooltip label="Who referred you to add this listing on Alephium?" />
            </Flex>
          ...
          <FormControl alignItems="center" gap={3} display="flex">
            <Flex>
              ...
              <ListingTooltip label="Private listings are only accessible through direct links and do not appear on the Alephium homepage or other public pages on the website." />
            </Flex>
            <Switch
              mb={2}
              id="isPrivate"
