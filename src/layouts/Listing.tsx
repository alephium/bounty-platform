    ...
    <Default
      meta={
        <Head>
          ...
          } by ${initialBounty?.sponsor?.name} | Alephium Listing`}</title>
          <meta
            name="description"
            content={`${getListingTypeLabel(initialBounty?.type ?? 'Listing')} on Alephium | ${
          ...
          <meta
            property="og:title"
            content={`${initialBounty?.title || 'Listing'} | Alephium`}
          />
          ...
          <meta property="og:image:alt" content="Contribium Bounty" />
