...
const SponsorListingsPage = ({ slug, sponsor, title, description }: Props) => {
  ...
  return (
    <Default
      ...
      meta={
        <Head>
          <title>{`${title} Opportunities | Alephium`}</title>
          <meta
            name="description"
            content={`
...
`}
          />
          <meta property="og:title" content={`${title} on Alephium`} />
          <meta property="og:image" content={ogImage.toString()} />
          <meta name="twitter:title" content={`${title} on Alephium`} />
