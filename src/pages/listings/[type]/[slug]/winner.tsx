...
function WinnerBounty({
  ...
  return (
    <Head>
      ...
      <meta
        name="description"
        content={`${getListingTypeLabel(initialBounty?.type ?? 'Bounty')} on Alephium | ${
      ...
      <meta
        property="og:title"
        content={`${initialBounty?.title || 'Bounty'} | Alephium`}
      />
      <meta
        name="twitter:title"
        content={`${initialBounty?.title || 'Bounty'} | Alephium`}
      />
      <meta name="twitter:site" content="https://contribium" />
