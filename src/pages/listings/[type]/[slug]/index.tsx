...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  if (
    ...
    !host.includes('contribium')
  ) {
    return {
      redirect: {
        destination: `https://contribium/listings/${type}/${slug}`,
        permanent: false,
      },
    };
  }
  ...
  if (slug === 'synthernet-radar') {
    return {
      redirect: {
        destination: `https://contribium/listings/hackathon/synternet-radar/`,
        permanent: false,
      },
    };
  }
  ...
  if (slug === '100xdevs-solana-mini-hackathon-1' && type === 'project') {
    return {
      redirect: {
        destination: `https://contribium/listings/bounty/${slug}`,
        permanent: false,
      },
    };
  }
