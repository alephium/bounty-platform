...
const Sponsor = () => {
  ...
  return (
    <>
      <Meta
        title="Find Top Talent for Your Crypto Projects on Alephium"
        description="Seeking top talent for your crypto project? Alephium connects you with experts for Bounties, Projects, and Grants in the crypto space."
